...
'| Data:       17/07/1997                                   |
'+----------------------------------------------------------+
'| Descrição:  Formulário para cadastro de títulos a pagar  |
'+----------------------------------------------------------+
...
Private Sub cmdInclusao_Click()
   ...
   Selecao = "SELECT * from Pagamento where NumeroTitulo=" & """"
   ...
   On Error GoTo ErrIncluiPagamento
   ErroPar = False
   MensErro = "Falha na abertura da consulta"
   
   Set Consulta = Banco.QueryDefs("InsPagamento")
   ErroPar = True
