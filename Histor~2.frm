...
Begin VB.Form frmHistoricoFornecedor 
   Caption         =   "Históricos de Fornecedores"
   ClientHeight    =   4455
   ClientLeft      =   1140
   ClientTop       =   1515
   ClientWidth     =   6315
...
Private Sub cmbCodinome_Click()
   ...
   ' Limpa o combo CMBORDEM  e alimenta-o com todos os números de ordem _
     dos históricos do Fornecedor selecionados
   cmbOrdem.Clear
   Do Until Tabela.EOF
...
Private Sub Form_Load()
   ' A rotina ComboFornecedor foi invocada na leitura do formulário-chamador _
     (frmFornecedor) e, aqui, uma segunda vez...
   ' Note que em FRMFornecedor também possuímos um combobox denominado CMBCODINOME: _
...
ErrGravaHistoricoFornecedor:
   MsgBox MensErro, 16, "Atualização de Histórico de Fornecedor"
